...
FGF2Cost = [float(4010000),float(2100000),float(0),float(0)] # FGF-2 cost (USD/g)
GConInBM = [float(0.0178),float(0.0267),float(0.0267),float(0.0356)] # Glucose concentration in basal media (mol/L)
TGFB = [float(161.8),float(161.8),float(161.8),float(161.8),float(0)] # Scenario TGF-b Costs
